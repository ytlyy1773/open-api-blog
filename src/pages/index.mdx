...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">开源接口<br/>简单、开源、免费的 api 接口</h1>
    <p className="subtitle">轻松打造全栈开源 API 项目<br className='sm:block hidden'/><a className="link" href="https://nestjs.com/" target="_blank">Nest.js</a> 与 <a className="link" href="https://nextjs.org" target="_blank">Next.js</a> 的完美结合</p>
    <p className="subtitle">
      <Link className={styles.cta} href="/docs">开始使用 <span>→</span></Link>
      <Link className={`${styles.cta} ${styles.brand}`} href="https://openapijs.vercel.app/" target="_blank">国际访问<span>→</span></Link>
    </p>
  </div>
  <style jsx>{`
    .content-container {
      ...
      margin: 0 auto;
      height: calc(100vh - var(--nextra-navbar-height) - 12.8rem);
    }
    .features-container {
      margin: 8rem 0 0;
      padding: 4rem 0;
